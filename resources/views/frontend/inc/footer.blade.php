<footer class="mt-4 overflow-hidden">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <span class="text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius
                                    ut distinctio nulla
                                    perspiciatis labore officia</span>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                ...
                                <li class="footer-menu-item"><a href="{{ route('all.product') }}">Products</a></li>
                                <li class="footer-menu-item"><a href="{{ route('about.us') }}">About Us</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                ...
                                <li class="footer-menu-item"><a href="{{ route('privacy.policy') }}">Privacy policy</a>
                                </li>
                                <li class="footer-menu-item"><a href="{{ route('term.condition') }}">Terms &
                                        Condition</a></li>
                                <li class="footer-menu-item"><a href="{{ route('contact.us') }}">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            <h4 class="footer-logo">
                                <a href="{{ route('index') }}">
                                    <h3 class="text-white">ECOMSTR</h3>
                                </a>
                            </h4>
                            <div class="footer-newsletter">
                                <p class="footer-text mb-3">Subscribe To Our Newsletter.</p>
        ...
        <div class="container">
            <div
                ...
                <ul class="footer-bottom-menu list-unstyled d-flex flex-wrap align-items-center mb-0">
                    ...
                    <li class="footer-menu-item"><a href="{{ route('term.condition') }}">Terms & Conditions</a></li>
                </ul>
                <p class="copyright footer-text">©<span class="current-year"></span> <a
                        href="{{ route('index') }}">ecomstr.com</a></p>
            </div>
        </div>
    </div>
</footer>
