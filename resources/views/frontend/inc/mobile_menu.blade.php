        ...
        <div class="offcanvas-body p-0 d-flex flex-column justify-content-between">
                            ...
                            <div class="container">
                                <div class="offcanvas-header border-btm-black">
                                    <h5 class="drawer-heading btn-menu-back d-flex align-items-center">
                                        ...
                                        <span class="menu-back-text">Category</span>
                                    </h5>
                                </div>
            ...
            <ul class="utility-menu list-unstyled">
                <li class="utilty-menu-item">
                    <a class="announcement-text" href="tel:+8801775484658">
                ...
                <li class="utilty-menu-item">
                    <a class="header-action-item header-wishlist" href="{{ route('wishlist.index') }}">
                        <span class="utilty-icon-wrapper">
