            ...
            <div class="col-lg-3 d-lg-block d-none">
                <div class="announcement-call-wrapper">
                    <div class="announcement-call">
                        <a class="announcement-text text-white" href="tel:+1-078-2376">Call: +8801775484658</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 d-lg-block d-none">
                    <nav class="site-navigation">
                        <ul class="main-menu list-unstyled justify-content-center">
                                        ...
                                        @foreach ($common_categories as $category)
                                            <li class="menu-list-item nav-item-sub">
                                                <a class="nav-link-sub nav-text-sub"
                                                    href="{{ route('category.product.show', $category->slug) }}">{{ $category->title }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                            ...
                            <li class="menu-list-item nav-item">
                                <a class="nav-link" href="{{ route('all.product') }}">Shop</a>
                            </li>
                            <li class="menu-list-item nav-item">
                ...
                <div class="col-lg-3 col-md-8 col-8">
                    <div class="header-action d-flex align-items-center justify-content-end">
                        ...
                        <!---- cart icon---->
                        @auth('web')
                            <a class="header-action-item header-cart cart-icon-head ms-4" href="#drawer-cart"
                                data-bs-toggle="offcanvas">
                                <span class="cart_count">{{ $user_carts->count() }}</span>
                                <svg class="icon icon-cart cart-icon-header" width="24" height="26" viewBox="0 0 24 26"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div class="container">
                <form action="{{ route('search.product') }}" class="search-form d-flex align-items-center"
                    ...
                    <div class="search-input mr-4">
                        <input type="text" name="keyword" placeholder="Search Products Or Category..."
                            autocomplete="off">
                    </div>
