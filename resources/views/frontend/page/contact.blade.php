...
@section('heading')
    <meta property="og:title" content="E-COM-STR E-Commerce Website | Contact Us">
    <meta property="og:description" content="E-COM-STR E-Commerce Website | Contact Us">
    <meta property="og:image" content="E-COM-STR E-Commerce Website | Contact Us" />
    <meta property="og:url" content="{{ url()->current() }}">
    <meta name="title" content="E-COM-STR E-Commerce Website | Contact Us" />
    <meta name="description" content="E-COM-STR E-Commerce Website | Contact Us" />
    <meta name="keywords" content="E-COM-STR E-Commerce Website | Contact Us" />
    <link rel="canonical" href="{{ url()->current() }}" />
    <title>E-COM-STR E-Commerce Website | Contact Us</title>
@endsection
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <a class="contact-info" href="mailto:ecomstr@gmail.com">ecomstr@gmail.com</a>
                                        <a class="contact-info" href="mailto:sohel@ecomstr.com">sohel@ecomstr.com</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <p class="contact-info">2715 house, road 5 , Uttara, Dhaka, bangladesh</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <a class="contact-info" href="tel:01721542525">01721542525</a>
                                        <a class="contact-info" href="tel:01923568952">01923568952</a>
                                    </div>
                                </div>
                            </div>
