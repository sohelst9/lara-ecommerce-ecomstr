...
@section('heading')
    <meta property="og:title" content="E-COM-STR E-Commerce Website | About Us">
    <meta property="og:description" content="E-COM-STR E-Commerce Website | About Us">
    <meta property="og:image" content="E-COM-STR E-Commerce Website | About Us" />
    <meta property="og:url" content="{{ url()->current() }}">
    <meta name="title" content="E-COM-STR E-Commerce Website | About Us" />
    <meta name="description" content="E-COM-STR E-Commerce Website | About Us" />
    <meta name="keywords" content="E-COM-STR E-Commerce Website | About Us" />
    <link rel="canonical" href="{{ url()->current() }}" />
    <title>E-COM-STR E-Commerce Website | About Us</title>
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="about-hero-img">
                                <img src="{{ asset('frontend/assets/img/about/about-hero.jpg') }}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-0 justify-content-center">
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="300">
                        <div class="promotional-item overlay-blue">
                            <img src="{{ asset('frontend/assets/img/about/p1.jpg') }}" alt="img">
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                        <div class="promotional-item overlay-black">
                            <img src="{{ asset('frontend/assets/img/about/p2.jpg') }}" alt="img">
                            <div class="promotional-absolute">
                                <div class="promotional-content text-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="1000">
                        <div class="promotional-item overlay-yellow">
                            <img src="{{ asset('frontend/assets/img/about/p3.jpg') }}" alt="img">
                            <div class="promotional-absolute">
                                <div class="promotional-content text-center">
                ...
                <div class="container">
                    <div class="about-banner-wrapper">
                        <div class="about-banner-content">
                            ...
                            <a href="{{ route('contact.us') }}" class="about-banner-btn">CONTACT US</a>
                        </div>
                    </div>
                </div>
            </div>
